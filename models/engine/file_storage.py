#!/usr/bin/python3
"""
Handling File Storage JSON of intances.
"""
import json
...
class FileStorage:
    ...
    """CNC - is a dictionary of the class names
    and class types.
    """
    ...
    def close(self):
        """
            clothing the reload moethod of objects.
        """
        self.reload()
